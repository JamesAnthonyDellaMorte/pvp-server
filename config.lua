...
config.get_config = function()
  ...
  data.colors =
  {
    { name = "orange" , color = {0.869, 0.5, 0.130, 0.5}},
    { name = "purple" , color = {0.485, 0.111, 0.659, 0.5}},
    { name = "red"    , color = {0.815, 0.024, 0.0, 0.5}},
    { name = "green"  , color = {0.093, 0.768, 0.172, 0.5}},
    { name = "blue"   , color = {0.155, 0.540, 0.898, 0.5}},
    { name = "yellow" , color = {0.835, 0.666, 0.077, 0.5}},
    { name = "pink"   , color = {0.929, 0.386, 0.514, 0.5}},
    { name = "white"  , color = {0.8, 0.8, 0.8, 0.5}},
    { name = "black"  , color = {0.1, 0.1, 0.1, 0.5}},
    { name = "gray"   , color = {0.4, 0.4, 0.4, 0.5}},
    { name = "brown"  , color = {0.300, 0.117, 0.0, 0.5}},
    { name = "cyan"   , color = {0.275, 0.755, 0.712, 0.5}},
    { name = "acid"   , color = {0.559, 0.761, 0.157, 0.5}}
  }
  ...
  data.teams =
  {
    {name = game.backer_names[math.random(#game.backer_names)], color = "orange", editable = true,team = "-", members = {}},
    {name = game.backer_names[math.random(#game.backer_names)], color = "purple", editable = true, team = "-", members = {}},
    {name = game.backer_names[math.random(#game.backer_names)], color = "red", editable = true, team = "-", members = {}},
    {name = game.backer_names[math.random(#game.backer_names)], color = "green", editable = true, team = "-", members = {}},
    {name = game.backer_names[math.random(#game.backer_names)], color = "yellow", editable = true, team = "-", members = {}},
    {name = game.backer_names[math.random(#game.backer_names)], color = "blue", editable = true,  team = "-", members = {}}
  }
